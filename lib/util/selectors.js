...
module.exports = { parse, selectorMatchesAnyScope, matcherForSelector, isSubsetX };
...
function isSubsetX(subset, superset) {
  result = false;
...
function anySelectorMatchesAnyScope(selectors, scopes) {
  if(Array.isArray()) {
