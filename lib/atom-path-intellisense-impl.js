...
const consts = require('./config/consts'),
  ...
  LessPathProvider = require('./providers/less-path.provider'),
  ...
  _registerFormatters() {
    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        self._logger.debug(`${self.formatters.length} formatters registered.`);
  ...
  _registerPathProviders() {
    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        self.pathProviders.push(new LessPathProvider());
