...
export default class NodeJSFormatter extends BaseFormatter{
  ...
  _formatBiModule(entry, prefix) {
    ...
    return {
      ...
      rightLabelHTML: `<span class="pi-rlabel bimodule">&nbsp;${source}</span>`,
  ...
  _formatFile(entry, prefix, searchPath, pathType) {
    ...
    return {
      ...
      rightLabelHTML: `<span title=\"&nbsp;File: ${pEntry.base}\" tooltip=\"${pEntry.base}\" class="pi-rlabel file">&nbsp;File: ${pEntry.base}</span>`,
  ...
  _formatDirectory(entry, prefix, searchPath, pathType) {
    ...
    return {
      ...
      type: "class",
      leftLabelHTML: `<span>&nbsp;${source}</span>`,
      rightLabelHTML: `<span title=\"&nbsp;Dir: ${entry}/\" class="pi-rlabel file">&nbsp;Dir: ${entry}/</span>`,
      description: `${path.normalize(searchPath + '/' + stringUtils.unescapeStringQuote(entry))}`,
      iconHTML: '<i class="icon-package"></i>'
    };
  }
